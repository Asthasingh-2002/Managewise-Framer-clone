    ...
    <div className="sub-container-2">
      ...
      <div className="section-box">
        <div className="sub-section">
         ...
         <div style={{fontSize:"1.3rem", fontWeight:"600"}}> Cross-Platform Compatibility</div>
      ...
      <div className="icon-box">
        ...
        <div className="sub-section">
        <div style={{fontSize:"1.3rem", fontWeight:"600"}}> Ctay Informed with Essential Notifications</div>
          <p style={{color:"rgb(118, 117, 117) "}}>
      ...
      <div className="section-box">
        ...
        <div style={{fontSize:"1.3rem", fontWeight:"600"}}> Secure Data Encryption at all times</div>
          <p style={{color:"rgb(118, 117, 117) "}}>
